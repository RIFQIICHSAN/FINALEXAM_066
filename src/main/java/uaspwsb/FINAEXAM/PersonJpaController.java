...
import uaspwsb.FINAEXAM.exceptions.NonexistentEntityException;
import uaspwsb.FINAEXAM.exceptions.PreexistingEntityException;
...
public class PersonJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("uaspwsb_FINAEXAM_jar_0.0.1-SNAPSHOTPU");
